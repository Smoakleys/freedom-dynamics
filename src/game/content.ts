...
export const CHYRON_STATIC = [
  ...
  'ENGINEERS DEMAND SECOND WHITEBOARD; TALKS STALL',
  'R&D CAPACITY EVAPORATES OVERNIGHT; NOBODY DIRECTED IT',
  'MECH TAKES FIRST STEPS; PROUD FOREMAN ALSO A MECH',
  'AIRSTRIKE RATED FIVE STARS BY EVERYONE UPWIND',
  'WEATHER FORECAST: SCATTERED ORDNANCE, CLEARING BY INVOICE',
  'COMPANY TOWN RENAMED AGAIN; MAPMAKERS UNIONIZE',
  'RENT COLLECTED FROM 55 TERRITORIES; MAILBOX REINFORCED',
  'FINAL OFFENSIVE REPELLED; SURVIVORS OFFERED INTERNSHIPS'
];
